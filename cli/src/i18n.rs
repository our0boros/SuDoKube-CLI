...
tr_map! {
    ...
    "menu.deleted" => { zh: "已删除对局", en: "Game deleted", ja: "対局削除済" },
    ...
    "game.mode_scrollbar" => { zh: "滚动", en: "Scroll", ja: "ｽｸﾛｰﾙ" },
    "game.mode_compact" => { zh: "精简", en: "Compact", ja: "簡易" },
...
pub fn animals(lang: Lang) -> &'static [&'static str] {
    match lang {
        ...
        Lang::En => &[
            "Panda", "Fox", "Rabbit", "Tiger", "Dolphin", "Owl", "Squirrel", "Penguin", "Deer",
            "Whale", "Cat", "Shiba", "Parrot", "Turtle", "Hedgehog", "Otter", "Raccoon", "Koala",
            "Flamingo", "Unicorn",
        ],
        Lang::Ja => &[
            "パンダ",
